...
import '../../../../controller/management/reportmanagement/sevicebysalercontroller.dart';
...
class ServiceBySalerManagerDialog extends StatefulWidget {
  const ServiceBySalerManagerDialog({Key? key}) : super(key: key);

  @override
  State<ServiceBySalerManagerDialog> createState() =>
      _ServiceBySalerManagerDialogState();
}

class _ServiceBySalerManagerDialogState
    extends State<ServiceBySalerManagerDialog> {
  final ServiceBySalerController controller = ServiceBySalerController();
  ...
  Widget build(BuildContext context) {
    ...
    return Dialog(
        ...
        child: SizedBox(
            width: width,
            height: height,
            child: ChangeNotifierProvider<ServiceBySalerController>.value(
                value: controller,
                child: Consumer<ServiceBySalerController>(
                    child: const Center(
                          ...
                          body: Stack(fit: StackFit.expand, children: [
                            ...
                            Align(
                                ...
                                child: NeutronButtonText(
                                    text:
                                        "${UITitleUtil.getTitleByCode(UITitleCode.TABLEHEADER_TOTAL)}: ${NumberUtil.numberFormat.format(controller.totalMoneyServiceCurrentPage)}")),
                          ]));
                    }))));
  }
      ...
      actions: [
        Container(
          ...
          child: NeutronTextFormField(
            isDecor: true,
            label: UITitleUtil.getTitleByCode(UITitleCode.TABLEHEADER_EMAIL),
