...
import '../../../controller/report/bookingofcreatorcontroller.dart';
...
class BookingOfCreatorDialog extends StatelessWidget {
  BookingOfCreatorDialog({Key? key}) : super(key: key);
  final BookingOfCreatorController controller = BookingOfCreatorController();
  ...
  Widget build(BuildContext context) {
    ...
    return Dialog(
      ...
      child: SizedBox(
          height: kHeight,
          width: width,
          child: ChangeNotifierProvider<BookingOfCreatorController>(
            create: (context) => controller,
            child: Consumer<BookingOfCreatorController>(
                ...
                Expanded(
                  ...
                  child: Container(
                    ...
                    child: NeutronTextContent(
                        color: ColorManagement.negativeText,
                        message: controller
                            .getStatusByBookingStatus(booking.status!)),
                  ),
                ),
                //menu
                Container(
