...
class CancelBookingsReport extends StatefulWidget {
  const CancelBookingsReport({Key? key}) : super(key: key);

  @override
  State<CancelBookingsReport> createState() => _CancelBookingsReportState();
}

class _CancelBookingsReportState extends State<CancelBookingsReport> {
  CancelBookingReportController? controller;

  @override
  void initState() {
    controller ??= CancelBookingReportController(BookingStatus.cancel);
    super.initState();
  }
