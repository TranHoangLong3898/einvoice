...
class DetailRevenueByDateReportDialog extends StatelessWidget {
  final RevenueByDateController controller;
  const DetailRevenueByDateReportDialog({Key? key, required this.controller})
      : super(key: key);
            ...
            children: [
                        ...
                        children: [
                          ...
                          NeutronTextTitle(
                              ...
                              message: UITitleUtil.getTitleByCode(UITitleCode
                                  .TOOLTIP_REVENUE_BY_DATE_REPORT_DETAI)),
                      ...
                      child: SingleChildScrollView(
                        child: DataTable(columnSpacing: 14, columns: [
                          ...
                          DataRow(cells: [
                            ...
                            DataCell(NeutronTextContent(
                              message: NumberUtil.numberFormat
                                  .format(controller.electricityWaterTotal),
                            ))
                          ]),
                          DataRow(cells: [
                            DataCell(NeutronTextContent(
                          ...
                          DataRow(cells: [
                            ...
                            DataCell(NeutronTextContent(
                              ...
                              message: NumberUtil.numberFormat
                                  .format(controller.totalAllRevenueByDate),
                            ))
                          ]),
                        ]),
                      ),
              ...
              Align(
                ...
                child: NeutronButton(
                  ...
                  onPressed: () async {
                    ExcelUlti.exportRevenueByDateDetail(controller, true);
                  },
                ),
              )
            ],
