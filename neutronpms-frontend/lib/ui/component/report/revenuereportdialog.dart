...
class RevenueReportDialog extends StatefulWidget {
  const RevenueReportDialog({Key? key}) : super(key: key);
        ...
        .map((booking) => Container(
              ...
              child: Row(
                children: [
                  ...
                  SizedBox(
                      ...
                      child: InkWell(
                        onTap: () {
                          showDialog(
                            context: context,
                            builder: (context) => ElectricityWaterDetail(
                              booking: booking,
                            ),
                          );
                        },
                  ...
                  Expanded(
                    child: NeutronTextContent(
                      message: booking.saler ?? "",
                      tooltip: booking.saler,
                      textAlign: TextAlign.end,
                    ),
                  ),
                  Container(
                      ...
                      padding: const EdgeInsets.only(
                          left: SizeManagement.cardInsideHorizontalPadding),
                      child: Checkbox(
                        value: booking.statusinvoice,
                        checkColor: ColorManagement.greenColor,
                        onChanged: (value) async {
                          await controller
                              .updateStatusInvoice(booking)
                              .then((result) {
      ...
      child: Row(
        children: [
          ...
          Expanded(
            ...
            textAlign: TextAlign.end,
            fontSize: 13,
            message: UITitleUtil.getTitleByCode(UITitleCode.TABLEHEADER_SALER),
          )),
          Container(
              width: 50,
              padding: const EdgeInsets.only(
