...
class DashboarMuchHotelsChart extends StatefulWidget {
  const DashboarMuchHotelsChart({Key? key}) : super(key: key);

  @override
  State<DashboarMuchHotelsChart> createState() =>
      _DashboarMuchHotelsChartState();
}

class _DashboarMuchHotelsChartState extends State<DashboarMuchHotelsChart> {
