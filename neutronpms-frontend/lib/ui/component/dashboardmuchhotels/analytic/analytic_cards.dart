...
class AnalyticCardsOfMuchHotels extends StatelessWidget {
  const AnalyticCardsOfMuchHotels({Key? key}) : super(key: key);
...
class _AnalyticInfoCardGridViewState extends State<AnalyticInfoCardGridView> {
  ...
  void initState() {
    analyticDataStage =
        DailyDataHotelsController.instance!.getDataAnalysisOfStage();
    analyticDataDate =
        DailyDataHotelsController.instance!.getDataAnalysisOfDate();
    super.initState();
  }
