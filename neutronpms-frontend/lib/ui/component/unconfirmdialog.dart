...
import 'package:ihotel/controller/unconfiromcontroller.dart';
...
class UnconfiromDialog extends StatelessWidget {
  const UnconfiromDialog({Key? key}) : super(key: key);
    ...
    return Dialog(
      ...
      child: Container(
        ...
        child: ChangeNotifierProvider(
          create: (context) => UnconfirmController(),
          child: Consumer<UnconfirmController>(
